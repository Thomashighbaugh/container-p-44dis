...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-p-44dis.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-p-44dis.containers.anotherwebservice.com/
...
```
git clone git@github.com:Thomashighbaugh/container-p-44dis.git
cd container-p-44dis
```
...
```
docker attach container-p-44dis
```
